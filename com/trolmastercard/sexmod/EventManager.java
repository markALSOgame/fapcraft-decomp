...
public class EventManager {
   public static void registerEventHandlers(boolean flag) throws IOException {
      ...
      MinecraftForge.EVENT_BUS.register(new GirlAttackHandler());
         ...
         MinecraftForge.EVENT_BUS.register(new ItemDragonStaff.a());
         ...
         MinecraftForge.EVENT_BUS.register(new ItemAlliesLamp.a());
   ...
   static void b() {
      ...
      MinecraftForge.EVENT_BUS.register(ClientChatHandler.Instance);
