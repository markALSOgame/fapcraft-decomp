...
public class ContainerLunaEquipment extends Container {
   LunaNpc LunaGirl;
   public Slot[] Slots;
   public UUID GirlUuid;
   public static List<ContainerLunaEquipment> OpenContainers = new ArrayList<>();

   public ContainerLunaEquipment(LunaNpc luna, InventoryPlayer inventory, UUID uuid) {
      this.GirlUuid = uuid;
                    ...
                    block13: {
                        ...
                        block12: {
                            ...
                            try {
                                ...
                                throw ContainerLunaEquipment.rethrow(runtimeException);
                            }
