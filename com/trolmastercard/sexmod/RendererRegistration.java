...
public class RendererRegistration {
   public static void registerEntityRenderers() {
      ...
      RenderingRegistry.registerEntityRenderingHandler(JennyNpc.class, arg1b -> new JennyNpcRenderer(arg1b, new ModelJenny(), -0.15));
      RenderingRegistry.registerEntityRenderingHandler(EllieNpc.class, arg1c -> new EllieNpcRenderer(arg1c, new ModelEllie(), 0.05));
      ...
      RenderingRegistry.registerEntityRenderingHandler(BeeNpc.class, arg1g -> new BeeNpcRenderer(arg1g, new ModelBee(), -0.4));
      RenderingRegistry.registerEntityRenderingHandler(SlimeRainEntity.class, bp::new);
      ...
      RenderingRegistry.registerEntityRenderingHandler(LunaFamiliarEntity.class, fi::new);
      ...
      RenderingRegistry.registerEntityRenderingHandler(EnergyBallEntity.class, ag::new);
      RenderingRegistry.registerEntityRenderingHandler(CultistEntity.class, e::new);
   }
}
